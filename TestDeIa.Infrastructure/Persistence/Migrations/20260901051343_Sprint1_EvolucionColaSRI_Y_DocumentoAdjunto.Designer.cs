...
namespace TestDeIa.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260901051343_Sprint1_EvolucionColaSRI_Y_DocumentoAdjunto")]
    partial class Sprint1_EvolucionColaSRI_Y_DocumentoAdjunto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.CertificadoDigitalEmpresaEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset>("FechaFinVigencia")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset>("FechaInicioVigencia")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.HasIndex("EmpresaId", "EsPrincipal");

                    b.HasIndex("EmpresaId", "FechaFinVigencia");

                    b.HasIndex("IsActive", "FechaFinVigencia");

                    b.ToTable("CertificadosDigitalesEmpresa", (string)null);
                });
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.ComprobanteCabeceraEntity", b =>
                {
                    ...
                    b.Property<string>("CodDocModificado")
                        .HasMaxLength(2)
                        .HasColumnType("nvarchar(2)");

                    b.Property<Guid?>("ComprobanteModificadoId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ComprobanteCabecera", (string)null);
                });

            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.ComprobanteDetalleEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ComprobanteCabeceraId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("FacturaDetalleOrigenId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FacturaDetalleOrigenId");
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.EmpresaEmisoraEntity", b =>
                {
                    ...
                    b.Property<string>("ProvinciaCodigo")
                        .HasMaxLength(80)
                        .HasColumnType("nvarchar(80)");
                    ...
                    b.Property<string>("SectorCodigo")
                        .HasMaxLength(80)
                        .HasColumnType("nvarchar(80)");
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.FacturaEntity", b =>
                {
                    ...
                    b.Property<decimal?>("VueltoEntregado")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.GeoCiudadEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("GeoCiudades", (string)null);
                });

            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.GeoProvinciaEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("GeoProvincias", (string)null);
                });
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.GeoRegionEntity", b =>
                {
                    ...
                    b.ToTable("GeoRegiones", (string)null);
                });

            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.GeoSectorEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CiudadId", "Codigo")
                        .IsUnique();

                    b.ToTable("GeoSectores", (string)null);
                });
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.ProductoEntity", b =>
                {
                    ...
                    b.Property<string>("NaturalezaItem")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)")
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.SecurityRoleEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            NormalizedName = "ASESORCOMERCIAL"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.TransferenciaInventarioDetalleEntity", b =>
                {
                    ...
                    b.HasIndex("TransferenciaInventarioId", "ProductoId")
                        .IsUnique();

                    b.ToTable("TransferenciasInventarioDetalle", (string)null);
                });

            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.TransferenciaInventarioEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("FechaTraslado")
                        .HasColumnType("datetimeoffset");

                    b.Property<Guid?>("GuiaRemisionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.CatalogoItemEntity", b =>
                {
                    ...
                    b.HasOne("TestDeIa.Infrastructure.Persistence.Entities.CatalogoItemEntity", "ParentItem")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.CertificadoDigitalEmpresaEntity", b =>
                {
                    b.HasOne("TestDeIa.Infrastructure.Persistence.Entities.EmpresaEmisoraEntity", "Empresa")
                        .WithMany("CertificadosDigitales")
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.ComprobanteCabeceraEntity", b =>
                {
                    b.HasOne("TestDeIa.Infrastructure.Persistence.Entities.FacturaEntity", "ComprobanteModificado")
                        .WithMany()
                        .HasForeignKey("ComprobanteModificadoId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("ComprobanteModificado");
                });

            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.ComprobanteDetalleEntity", b =>
                {
                    b.HasOne("TestDeIa.Infrastructure.Persistence.Entities.ComprobanteCabeceraEntity", "ComprobanteCabecera")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.GeoCiudadEntity", b =>
                {
                    b.HasOne("TestDeIa.Infrastructure.Persistence.Entities.GeoProvinciaEntity", "Provincia")
                        .WithMany("Ciudades")
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.GeoProvinciaEntity", b =>
                {
                    b.HasOne("TestDeIa.Infrastructure.Persistence.Entities.GeoRegionEntity", "Region")
                        .WithMany("Provincias")
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.GeoSectorEntity", b =>
                {
                    b.HasOne("TestDeIa.Infrastructure.Persistence.Entities.GeoCiudadEntity", "Ciudad")
                        .WithMany("Sectores")
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.TransferenciaInventarioDetalleEntity", b =>
                {
                    ...
                    b.HasOne("TestDeIa.Infrastructure.Persistence.Entities.TransferenciaInventarioEntity", "TransferenciaInventario")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.TransferenciaInventarioEntity", b =>
                {
                    b.HasOne("TestDeIa.Infrastructure.Persistence.Entities.BodegaEntity", "BodegaDestino")
                        .WithMany("TransferenciasDestino")
                        .HasForeignKey("BodegaDestinoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TestDeIa.Infrastructure.Persistence.Entities.BodegaEntity", "BodegaOrigen")
            ...
            modelBuilder.Entity("TestDeIa.Infrastructure.Persistence.Entities.EmpresaEmisoraEntity", b =>
                {
                    b.Navigation("CertificadosDigitales");
